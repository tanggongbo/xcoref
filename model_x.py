    ...
    def get_predictions_and_loss(self, input_ids_src, input_mask_src, speaker_ids_src, sentence_len_src, genre_src,
        ...
        if do_loss:
            ...
            if conf["coref_loss_both"] or conf["with_agreement"]:
                ...
                top_span_mention_scores_trg, speaker_ids_trg = self.get_span_rep(self.bert, "target",
                                                                                 is_training_trg,
            ...
            if conf['eval_only_trg']:
                # only deal with the target-side
                bert, side, is_training, input_ids, input_mask, speaker_ids, sentence_map, genre, \
                gold_starts, gold_ends, gold_mention_cluster_map = self.bert, "target", is_training_trg, \
