...
class CorefModel(nn.Module):
    ...
    def get_span_rep(self, bert, side, is_training, input_ids, input_mask, speaker_ids, sentence_map, gold_starts,
        ...
        if conf['model_heads']:
            mention_token_attn = self.mention_token_attn
            token_attn = torch.squeeze(mention_token_attn(mention_doc), 1)
        else:
        ...
        top_span_cluster_ids = candidate_labels if is_training else None
    ...
    def get_predictions_and_loss(self, input_ids_src, input_mask_src, speaker_ids_src, sentence_len_src, genre_src,
        ...
        if do_loss:
            ...
            if conf["coref_loss_both"]:
                loss_coref += self.do_scoring(top_span_emb_trg, top_span_starts_trg, top_span_ends_trg,
            ...
            if conf["with_agreement"]:
                ...
                for src_span in top_span_emb_src:
                    ...
                    pairwise_scores_src = torch.squeeze(self.coref_score_ffnn(pair_emb), -1).reshape(1, -1)
